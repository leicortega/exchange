						...
						<div class="col-md-12 col-12">
							<nav aria-label="breadcrumb" class="page-breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Perfil Creador</li>
								</ol>
							</nav>
							<h2 class="breadcrumb-title">Perfil Creador</h2>
						</div>
					</div>
				</div>
			</div>
							...
							<div class="doctor-widget">
								<div class="doc-info-left">
									...
									<div class="doc-info-cont">
										...
										<p class="doc-speciality">Estudiante de Ingnenieria</p>
										<p class="doc-department"><img src="assets/img/specialities/specialities-05.png" class="img-fluid" alt="Speciality">Programador</p>
										<div class="rating">
										...
										<div class="clinic-details">
											<p class="doc-location"><i class="fas fa-map-marker-alt"></i> Neiva, Huila - <a href="javascript:void(0);">Ver Direccion</a></p>
								...
								<div class="doc-info-right">
									<div class="clini-infos">
										<ul>
											...
											<li><i class="fas fa-map-marker-alt"></i> Neiva, Huila</li>
									...
									<div class="clinic-booking">
										<a class="apt-btn" href="booking">Solicitar clase</a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card-body pt-0">
							...
							<nav class="user-tabs mb-4">
								<ul class="nav nav-tabs nav-tabs-bottom nav-justified">
									<li class="nav-item">
										<a class="nav-link active" href="#doc_overview" data-toggle="tab">Sobre mi</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="#doc_locations" data-toggle="tab">Clases</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="#doc_reviews" data-toggle="tab">Cursos</a>
									</li>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Leiner\USCO\20191178893\3er Semestre\Ingenieria de Software\Proyecto Final\doccure-10\template\resources\views/doctor-profile.blade.php ENDPATH**/ ?>